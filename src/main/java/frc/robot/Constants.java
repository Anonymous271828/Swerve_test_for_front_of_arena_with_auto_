...
public final class Constants {
  public static final class DriveConstants {
    ...
    //ANGULAR OFFSETS ARE THE DIFFERENCE IN ANGLE BETWEEN THE WHEELS ZERO'D POSITION AND IT'S DRIVING FORWARD ANGLE
  ...
  public static final class ModuleConstants {
    ...
    public static final double kOverallMaxOutput = 0.75;
    // Original P is 0.04
    public static final double kDrivingP = 0.2;
    public static final double kDrivingI = 0; // Integral results in uncontrolled movement [maybe setup]
    public static final double kDrivingD = 0.02;
    public static final double kDrivingFF = 1 / kDriveWheelFreeSpeedRps;
    public static final double kDrivingMinOutput = -kOverallMaxOutput;
    public static final double kDrivingMaxOutput = kOverallMaxOutput;

    // STATS FOR PID CONTROL
    // TURNING P = 0.7
    // TURNING I = 0
    // TURNING D = 0.5
    ...
    public static final double kTurningMinOutput = -kOverallMaxOutput;
    public static final double kTurningMaxOutput = kOverallMaxOutput;
  ...
  public static final class Shooter_Intake_constants {
    ...
    public static final int Climber1_port = 2;
